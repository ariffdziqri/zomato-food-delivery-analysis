...
df$distance_round = round(df$distance_miles, digits=0)
df <- df %>% filter(distance_miles<1000)
```
...
```{r}
set.seed(133)
cluster5 <- cluster_f(cluster_df, 5)
